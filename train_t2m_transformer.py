...
from models.mask_transformer.transformer_disentangled import DMaskTransformer
from models.mask_transformer.transformer_trainer import MaskTransformerTrainer
from models.mask_transformer.transformer_trainer_disentangled import DMaskTransformerTrainer
...
if __name__ == '__main__':
    ...
    if not opt.disentangled:
        ...
        opt.vq_conditional = vq_opt.conditional
        t2m_transformer = DMaskTransformer(code_dim_m=vq_opt.code_dim_m,
    ...
    if not opt.disentangled:
        ...
        trainer = DMaskTransformerTrainer(opt, t2m_transformer, vq_model)
