...
class TrainT2MOptions(BaseOptions):
    def initialize(self):
        ...
        '''optimizer'''
        self.parser.add_argument('--SFO', action="store_true", help='Use Scheduler Free Optimizer')
        ...
        self.parser.add_argument('--tiny', action="store_true", help='flag for using all data or tiny version of it')
        
        self.parser.add_argument('--disentangled', action="store_true", help='flag for using disentangled model')


        self.is_train = True
        self.model_stage = 'transformer'
